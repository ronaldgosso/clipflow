...
In addition to the Contributor Covenant, we have a few project-specific expectations:

### Code Review Etiquette

- **Be constructive**: Focus on the code, not the person
- **Explain your reasoning**: Don't just say "change this" — explain why
- **Acknowledge good work**: Praise excellent solutions and creative approaches
...
- **Email**: Private matters (ronaldgosso@gmail.com)
...
1. **Email**: ronaldgosso@gmail.com
2. **Include**: Description of the incident, relevant links/screenshots
...
**Thank you for helping make clipflow a welcoming and inclusive community!** 🎬
